...
# Identical to the upstream Mailhog formula except for a patch to use a safer
# bind address. See https://github.com/Homebrew/homebrew-core/pull/124958
#
# TODO(ivy): Remove once this fix lands upstream.
